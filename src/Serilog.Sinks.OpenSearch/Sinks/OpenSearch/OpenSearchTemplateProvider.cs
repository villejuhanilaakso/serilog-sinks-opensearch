...
{
    /// <summary>
    /// OpenSearch version to use for the automatic template registering.
    /// </summary>
    // TODO: leaving this for now, check Open search version specific changes.
    ...
    /// <summary>
    /// Provider for version specific OpenSearch templates.
    /// </summary>
    // TODO: leaving this for now, check Open search version specific changes.
    public class OpenSearchTemplateProvider
    {
        ...
        private static object GetTemplateESv7(OpenSearchSinkOptions options, string discoveredVersion,
            Dictionary<string, string> settings,
            string templateMatchString)
        {
            object mappings = new
        ...
        private static object GetTemplateESv6(OpenSearchSinkOptions options, string discoveredVersion,
            Dictionary<string, string> settings,
            string templateMatchString)
        {
            object mappings = new
